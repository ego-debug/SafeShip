...
def reset_safeloop():
    """Reload the safeloop package between tests so module-level state
    (config, transport thread) doesn't leak."""
    import safeloop
    import safeloop._config as _config
    import safeloop._transport as _transport
    import safeloop._wrap as _wrap
    ...
    cfg.api_key = None
    cfg.endpoint = "https://safeloop.dev/v1/traces"
