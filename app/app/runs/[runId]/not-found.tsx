  ...
  return (
    <main className="grid place-items-center py-24">
      ...
      >
        ...
        <Link
          href="/app/dashboard"
          className="mx-auto inline-flex items-center gap-2 rounded-[9px] bg-accent px-4 py-2.5 text-sm font-semibold text-bg shadow-[0_0_0_1px_rgba(194,249,112,0.35),0_12px_24px_-12px_rgba(0,0,0,0.55)] transition hover:-translate-y-px hover:bg-[#d3ff85]"
        >
          ← back to dashboard
        </Link>
      </div>
