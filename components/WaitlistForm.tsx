      ...
      >
        ...
        <span>
          {status === "duplicate"
            ...
            : "You're in. We'll email you when SafeLoop opens up."}
        </span>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-wrap items-center gap-2.5">
      ...
      <button
        type="submit"
        disabled={status === "submitting"}
        className="rounded-[9px] bg-accent px-[18px] py-3 text-[14.5px] font-semibold text-bg shadow-[0_0_0_1px_rgba(194,249,112,0.4),0_10px_24px_-10px_rgba(194,249,112,0.4)] transition hover:-translate-y-px hover:bg-[#d3ff85] disabled:opacity-60"
      >
